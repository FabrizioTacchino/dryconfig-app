...
interface FrameMaterialFormProps {
  formData: MaterialFormData;
  setFormData: React.Dispatch<React.SetStateAction<MaterialFormData>>;
  isSubmitting: boolean;
}

const FrameMaterialForm = ({ formData, setFormData, isSubmitting }: FrameMaterialFormProps) => {
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              disabled={isSubmitting}
              placeholder="Inserire eventuali note specifiche per l'installazione del montante"
            />
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              I montanti in acciaio hanno sempre classe antincendio A1
            </p>
          </div>
